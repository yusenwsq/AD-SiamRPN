...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = '..\data2\got10k\crop511'
__C.DATASET.GOT.ANNO = '..\data2\got10k/train.json'
__C.DATASET.GOT.FRAME_RANGE = 1000
...
__C.BACKBONE.TRAIN_EPOCH = 0 #第10层开始训练
...
# Long term lost search size  831
__C.TRACK.LOST_INSTANCE_SIZE = 831

# Long term confidence low 0.85
__C.TRACK.CONFIDENCE_LOW = 0.85

# Long term confidence high 0.998
